...
public class TargetType  implements java.io.Serializable {
    ...
    /**
     * Gets the ID value for this TargetType.
     * 
     * @return ID
     */
    ...
    /**
     * Sets the ID value for this TargetType.
     * 
     * @param ID
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TargetType)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TargetType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/Common/V2", "TargetType"));
