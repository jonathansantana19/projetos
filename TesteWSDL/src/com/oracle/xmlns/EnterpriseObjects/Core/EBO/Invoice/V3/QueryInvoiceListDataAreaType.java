/**
 * QueryInvoiceListDataAreaType.java
 *
...
public class QueryInvoiceListDataAreaType  implements java.io.Serializable {
    private com.oracle.xmlns.EnterpriseObjects.Core.Common.V2.QueryCriteriaType[] query;

    public QueryInvoiceListDataAreaType() {
    }
    ...
    /**
     * Gets the query value for this QueryInvoiceListDataAreaType.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this QueryInvoiceListDataAreaType.
     * 
     * @param query
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryInvoiceListDataAreaType)) return false;
        QueryInvoiceListDataAreaType other = (QueryInvoiceListDataAreaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryInvoiceListDataAreaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "QueryInvoiceListDataAreaType"));
