/**
 * QueryInvoiceARListResponseType.java
 *
...
public class QueryInvoiceARListResponseType  extends com.oracle.xmlns.EnterpriseObjects.Core.EBO.Invoice.V3.InvoiceEBMType  implements java.io.Serializable {
    public QueryInvoiceARListResponseType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryInvoiceARListResponseType)) return false;
        QueryInvoiceARListResponseType other = (QueryInvoiceARListResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryInvoiceARListResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "QueryInvoiceARListResponseType"));
    }
