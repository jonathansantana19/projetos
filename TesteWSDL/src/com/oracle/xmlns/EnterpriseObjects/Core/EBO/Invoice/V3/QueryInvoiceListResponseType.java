/**
 * QueryInvoiceListResponseType.java
 *
...
public class QueryInvoiceListResponseType  extends com.oracle.xmlns.EnterpriseObjects.Core.EBO.Invoice.V3.InvoiceEBMType  implements java.io.Serializable {
    public QueryInvoiceListResponseType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryInvoiceListResponseType)) return false;
        QueryInvoiceListResponseType other = (QueryInvoiceListResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryInvoiceListResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "QueryInvoiceListResponseType"));
    }
