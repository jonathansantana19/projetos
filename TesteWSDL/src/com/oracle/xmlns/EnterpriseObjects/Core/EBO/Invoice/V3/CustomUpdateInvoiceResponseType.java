/**
 * CustomUpdateInvoiceResponseType.java
 *
...
public class CustomUpdateInvoiceResponseType  extends com.oracle.xmlns.EnterpriseObjects.Core.EBO.Invoice.V3.InvoiceEBMType  implements java.io.Serializable {
    public CustomUpdateInvoiceResponseType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomUpdateInvoiceResponseType)) return false;
        CustomUpdateInvoiceResponseType other = (CustomUpdateInvoiceResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomUpdateInvoiceResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "CustomUpdateInvoiceResponseType"));
    }
