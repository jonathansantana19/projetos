...
public class InvoiceEBMType  extends com.oracle.xmlns.EnterpriseObjects.Core.EBO.Invoice.V3.InvoiceEBOType  implements java.io.Serializable {
    public InvoiceEBMType() {
    }
...
//            custom);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvoiceEBMType)) return false;
        InvoiceEBMType other = (InvoiceEBMType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InvoiceEBMType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "InvoiceEBMType"));
    }
