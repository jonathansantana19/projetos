/**
 * QueryLastInvoiceResponseType.java
 *
...
public class QueryLastInvoiceResponseType  extends com.oracle.xmlns.EnterpriseObjects.Core.EBO.Invoice.V3.InvoiceEBMType  implements java.io.Serializable {
    public QueryLastInvoiceResponseType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryLastInvoiceResponseType)) return false;
        QueryLastInvoiceResponseType other = (QueryLastInvoiceResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryLastInvoiceResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "QueryLastInvoiceResponseType"));
    }
