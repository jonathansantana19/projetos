...
public class QueryInvoiceReportType  extends com.oracle.xmlns.EnterpriseObjects.Core.EBO.Invoice.V3.InvoiceEBMType  implements java.io.Serializable {
    public QueryInvoiceReportType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryInvoiceReportType)) return false;
        QueryInvoiceReportType other = (QueryInvoiceReportType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryInvoiceReportType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Invoice/V3", "QueryInvoiceReportType"));
    }
